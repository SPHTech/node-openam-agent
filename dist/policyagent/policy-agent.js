...
exports.PolicyAgent = exports.NOTIFICATION_PATH = exports.CDSSO_PATH = exports.SESSION_EVENT = void 0;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        profile = _a.sent();
                        this.sessionCache.put(sessionId, __assign(__assign({}, profile), { valid: true }));
        ...
        return function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        session = _a.sent();
                        req['session'] = __assign(__assign({}, req['session']), session);
                        next();
                        return [3 /*break*/, 3];
                    case 2:
                        err_4 = _a.sent();
        ...
        router.post(path, BodyParser.urlencoded({ extended: false }), function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        _c.sent();
                        res.redirect((_b = (_a = req.query.goto) === null || _a === void 0 ? void 0 : _a.toString()) !== null && _b !== void 0 ? _b : '/');
                        return [3 /*break*/, 5];
                    case 4:
                        err_5 = _c.sent();
                        fail(err_5, res);
